...
authRoutes.get("/google/callback", passportSetup_1.default.authenticate("google", {
    ...
    try {
        ...
        (0, auth_controller_2.setHttpOnlyCookie)(res, "accessToken", data.accessToken, 15 * 60 * 1000);
        (0, auth_controller_2.setHttpOnlyCookie)(res, "refreshToken", data.refreshToken, 15 * 60 * 1000);
        yield (0, response_1.successResponse)(res, 201, "User authenticated successfully", data);
    }
    catch (error) {
